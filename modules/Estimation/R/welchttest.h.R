...
WelchTTestOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "WelchTTestOptions",
...
WelchTTestResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "WelchTTestResults",
    ...
    public=list(
        initialize=function(options) {
            super$initialize(
                options=options,
                name="",
                title="Welch Approximate T-Test")
            self$add(jmvcore::Preformatted$new(
                options=options,
                name="conclusion",
                title=""))}))

WelchTTestBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "WelchTTestBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = WelchTTestResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
WelchTTest <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("WelchTTest requires jmvcore to be installed (restart may be required)")
